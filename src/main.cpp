...
uint256 hashGenesisBlock("0xe82fd1aa0a448cad4536690527ce202b8d27ee21c4c54619742e452b72b36aa8");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // UticaCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "UticaCoin Signed Message:\n";
...
{
    // UticaCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1840000); // UticaCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 315000; // UticaCoin: 3.5 days
static const int64 nTargetSpacing = 315; // UticaCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // UticaCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // UticaCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // UticaCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfac7d4e5bdf5e2424ce20e86a8c68937de8c17d2e043fa45910bc781f0cfb1b6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d8654a962ea1487c86d97a19e493cc5cdcdea615444ea30d7829144af1f97eb18cdef8fc16b4a5822f103edbe2b07451c5aed682d731475c9fd458ebfce56d3de5") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515628709;
        block.nBits    = 504365644;
        block.nNonce   = 2675318438;

        if (fTestNet)
        {
            block.nTime    = 1515628709;
            block.nNonce   = 1012647126;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x42fc99430c2f294778beefeb5cc1c0bcbe1145adb87f770c09f5d1e2d6792c99"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // UticaCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UticaCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UticaCoinMiner : ProcessBlock, block not accepted");
    }
